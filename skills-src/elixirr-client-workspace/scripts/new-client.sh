...
copy_template "$TEMPLATE_DIR/working-memory-current.md" "$CLIENT_DIR/working-memory/current.md"
copy_template "$TEMPLATE_DIR/working-memory-backlog.md" "$CLIENT_DIR/working-memory/backlog.md"
copy_template "$TEMPLATE_DIR/working-memory-risks.md" "$CLIENT_DIR/working-memory/risks.md"
copy_template "$TEMPLATE_DIR/working-memory-timeline.md" "$CLIENT_DIR/working-memory/timeline.md"
copy_template "$TEMPLATE_DIR/automations-notes.md" "$CLIENT_DIR/outputs/automations/notes.md"
copy_template "$TEMPLATE_DIR/automations-config.md" "$CLIENT_DIR/outputs/automations/config.md"
