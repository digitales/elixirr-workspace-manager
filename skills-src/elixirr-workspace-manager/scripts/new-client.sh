...
mkdir -p "$CONTEXT_DIR"
mkdir -p "$CLIENT_DIR/working-memory"
mkdir -p "$CLIENT_DIR/meetings/recurring"
mkdir -p "$CLIENT_DIR/meetings/ad-hoc"
mkdir -p "$CLIENT_DIR/projects"
mkdir -p "$CLIENT_DIR/outputs/automations"
mkdir -p "$CLIENT_DIR/outputs/communications"
...
copy_template "$TEMPLATE_DIR/meeting-note.md" "$CLIENT_DIR/meetings/recurring/_template.md"
copy_template "$TEMPLATE_DIR/client-working-memory-current.md" "$CLIENT_DIR/working-memory/current.md"
copy_template "$TEMPLATE_DIR/client-working-memory-backlog.md" "$CLIENT_DIR/working-memory/backlog.md"
copy_template "$TEMPLATE_DIR/client-working-memory-risks.md" "$CLIENT_DIR/working-memory/risks.md"
copy_template "$TEMPLATE_DIR/client-working-memory-timeline.md" "$CLIENT_DIR/working-memory/timeline.md"
copy_template "$TEMPLATE_DIR/client-automations-notes.md" "$CLIENT_DIR/outputs/automations/notes.md"
copy_template "$TEMPLATE_DIR/client-automations-config.md" "$CLIENT_DIR/outputs/automations/config.md"
