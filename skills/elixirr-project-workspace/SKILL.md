...
description: Create and maintain an Elixirr project workspace scaffold under an existing client in the default local workspace root or a user-specified root. Use when the user asks to create a project, initialize project context, add project meetings folders, or prepare outputs and automations folders for a client project.
---
